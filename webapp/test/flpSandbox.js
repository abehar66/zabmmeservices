		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Servicios de un Trabajador",
									"targetURL": "#zabmmeservices-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zabmmeservices-display": {
								"semanticObject": "zabmmeservices",
								"action": "display",
								"description": "Servicios de un Trabajador",
								"title": "Servicios de un Trabajador",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zabmmeservices",
									"url": sap.ui.require.toUrl("zabmmeservices")
								}
							}
						}
					}
